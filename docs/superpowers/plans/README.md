...
- [Plan 4: SSH, SOCKS, exit-node, exec, DERP, tray](2026-09-21-tailcat-desktop-client-plan-4.md) — SSH serve/client (no-auth confirmations), SOCKS, exit-node, exec, Keys DERP/region, system tray
