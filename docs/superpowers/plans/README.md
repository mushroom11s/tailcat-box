...
- [Local transcript multi-select delete](2026-09-22-tailcat-box-chat-multiselect-delete.md) — **planned.** Drag-rect multi-select, top bar, confirm local discard; remove burn-bubble Delete. Design: [multi-select delete spec](../specs/2026-09-22-tailcat-box-chat-multiselect-delete-design.md).
...
- [Phase 4: Live voice, video, and screen share](2026-09-22-tailcat-box-chat-phase-4.md) — **implemented.** Webview WebRTC with port 100 signaling only.
