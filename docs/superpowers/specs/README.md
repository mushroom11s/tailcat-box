...
- [Tailcat Desktop Client (toolbox)](2026-09-21-tailcat-desktop-client-design.md) — original Mac/Windows GUI spec. Plans 1–4 implemented that toolbox. The product goal and primary navigation are superseded by the Tailcat Box spec.
