...
- **喵传** — 打开后的第一屏。拖入文件，可以同时开多份分享。不超过 300 MiB 的会复制到应用里；更大的留在原路径，请不要移动。每份有自己的二维码，中心是抠好的打包猫。打包时会看到那只猫，下载进度上有一只在跑的猫。可以粘贴分享码，也可以用摄像头、图片或剪贴板扫码。另一台猫砂盆在这台电脑保持在线时，通过 Tailcat 把其中一份下载走
