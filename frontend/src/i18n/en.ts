export const en = {
  ...
  miaoPathDERP: "Relay",
  miaoPathRelayOfficial: "Tailcat official relay",
  miaoPathRelayOfficialNamed: "Tailcat official relay · {name}",
  miaoPathRelayCustom: "Self-hosted relay · {name}",
  miaoPathRelayCustomBare: "Self-hosted relay",
