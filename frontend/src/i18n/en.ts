export const en = {
  ...
  miaoPathDERP: "Relay",
  miaoPathRelayTailscale: "Via the Tailscale {name} relay",
  miaoPathRelayPublic: "Via the public relay",
  miaoPathRelayCustom: "Via a self-hosted relay ({name})",
  miaoPathRelayCustomBare: "Via a self-hosted relay",
